...
def binary_classification_segment_auc_curve(
    ...
    selected_threshold: float | collections.Iterable
        The threshold that you want to gain the precision and recall.
    ...
    -------
    convasjs : ConvasJS
        The convajs object of auc curve.

    selected_p: A list consisting of the selected precision which
     are generated by `selected_threshold`.

    selected_r: A list consisting of the selected recall which
     are generated by `selected_threshold`.
    """
    ...
    if selected_threshold is not None:
        if isinstance(selected_threshold, (float, int)):
        ...
        for sel_th in selected_threshold:
            ...
            for index in range(len(t1)):
                if sel_th < t1[index] < tur_th:
                    tur_th = t1[index]
                    tur_p = p1[index]
                    tur_r = r1[index]
            selected_p.append(tur_p)
