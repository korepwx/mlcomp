...
class ElementsTestCase(unittest.TestCase):
    ...
    def test_HTML(self):
        ...
        self.assertEqual(
            ...
            {"__id__": 0, "__type__": "HTML", "html": "<span>text</span>",
             "name": "HTML element"}
        )
    ...
    def test_Text(self):
        ...
        self.assertEqual(
            json.loads(r.to_json(sort_keys=True)),
            {"__id__": 0, "__type__": "Text", "name": "Text element",
             "text": "text"}
        )
    ...
    def test_ParagraphText(self):
        ...
        self.assertEqual(
            json.loads(r.to_json(sort_keys=True)),
            {"__id__": 0, "__type__": "ParagraphText",
             "name": "ParagraphText element",
             "text": "paragraph text"}
        )
    ...
    def test_LineBreak(self):
        ...
        self.assertEqual(
            json.loads(r.to_json(sort_keys=True)),
            {"__id__": 0, "__type__": "LineBreak",
             "name": "LineBreak element"}
        )
    ...
    def test_InlineMath(self):
        ...
        self.assertEqual(
            json.loads(r.to_json(sort_keys=True)),
            {"__id__": 0, "__type__": "InlineMath", "latex": "x+1",
             "name": "InlineMath element"}
        )
    ...
    def test_BlockMath(self):
        ...
        self.assertEqual(
            json.loads(r.to_json(sort_keys=True)),
            {"__id__": 0, "__type__": "BlockMath", "latex": "x+1",
             "name": "BlockMath element"}
        )
    ...
    def test_Image(self):
        ...
        with TemporaryDirectory() as tempdir:
            ...
            self.assertEqual(
                json.loads(r.to_json(sort_keys=True)),
                {"__id__": 0, "__type__": "Image", "content_type": "image/png",
                 "name_scope": "image", "path": "res/image.png"}
            )
        ...
        with TemporaryDirectory() as tempdir:
            ReportSaver(tempdir).save(r)
            r_config = {"__id__": 0, "__type__": "Image", "extension": ".jpg",
                        "name_scope": "image", "path": "res/image.jpg"}
            if Magic:
                r_config['content_type'] = 'image/jpeg'
            self.assertEqual(json.loads(r.to_json(sort_keys=True)), r_config)
    ...
    def test_Table(self):
        ...
        self.assertEqual(
            ...
            {'__id__': 0,
             '__type__': 'TableCell',
             'children': [{'__id__': 1, '__type__': 'Text', 'text': 'text'}],
             'colspan': 2,
             'name': 'Table Cell',
             'rowspan': 1}
        )
        ...
        self.assertEqual(
            ...
            {'__id__': 0,
             ...
             'cells': [{'__id__': 1,
                        '__type__': 'TableCell',
                        'children': [{'__id__': 2, '__type__': 'Text', 'text': 'text1'}]},
                       {'__id__': 3,
                        '__type__': 'TableCell',
                        'children': [{'__id__': 4, '__type__': 'Text', 'text': 'text2'}]}]}
        )
        self.assertEqual(
            json.loads(Report.from_json(r.to_json(sort_keys=True)).
            ...
            {'__id__': 0,
             ...
             'footer': [{'__id__': 1,
                         ...
                         'cells': [{'__id__': 2,
                                    ...
                                    'children': [{'__id__': 3,
                                                  '__type__': 'Text',
                                                  'name_scope': 'my_table/table_row_3/table_cell/text',
                                                  'text': 'footer1'}],
                                    'name_scope': 'my_table/table_row_3/table_cell'}],
                         'name_scope': 'my_table/table_row_3'},
                        {'__id__': 4,
                         '__type__': 'TableRow',
                         'cells': [{'__id__': 5,
                                    '__type__': 'TableCell',
                                    'children': [{'__id__': 6,
                                                  '__type__': 'Text',
                                                  'name_scope': 'my_table/table_row_4/table_cell/text',
                                                  'text': 'footer2'}],
                                    'name_scope': 'my_table/table_row_4/table_cell'}],
                         'name_scope': 'my_table/table_row_4'}],
             'header': [{'__id__': 7,
                         '__type__': 'TableRow',
                         'cells': [{'__id__': 8,
                                    '__type__': 'TableCell',
                                    'children': [{'__id__': 9,
                                                  '__type__': 'Text',
                                                  'name_scope': 'my_table/table_row_2/table_cell/text',
                                                  'text': 'header'}],
                                    'name_scope': 'my_table/table_row_2/table_cell'}],
                         'name_scope': 'my_table/table_row_2'}],
             'name': 'My Table',
             'name_scope': 'my_table',
             'rows': [{'__id__': 10,
                       '__type__': 'TableRow',
                       'cells': [{'__id__': 11,
                                  ...
                                  'children': [{'__id__': 12,
                                                '__type__': 'Text',
                                                'name_scope': 'my_table/table_row/table_cell/text',
                                                'text': 'row1'}],
                                  'name_scope': 'my_table/table_row/table_cell'}],
                       'name_scope': 'my_table/table_row'},
                      {'__id__': 13,
                       '__type__': 'TableRow',
                       'cells': [{'__id__': 14,
                                  '__type__': 'TableCell',
                                  'children': [{'__id__': 15,
                                                '__type__': 'Text',
                                                'name_scope': 'my_table/table_row_1/table_cell/text',
                                                'text': 'row2'}],
                                  'name_scope': 'my_table/table_row_1/table_cell'}],
                       'name_scope': 'my_table/table_row_1'}],
             'title': 'My Table Title'}
        )
        self.assertEqual(
            json.loads(Report.from_json(r.to_json(sort_keys=True)).
    ...
    def test_Block(self):
        ...
        self.assertEqual(
            ...
            {'__id__': 0,
             ...
             'children': [{'__id__': 1,
                           '__type__': 'Text',
                           'name_scope': 'block_element/text',
                           'text': 'text'}],
             'name': 'Block element',
             'name_scope': 'block_element'}
        )
    ...
    def test_Section(self):
        ...
        self.assertEqual(
            ...
            {'__id__': 0,
             ...
             'children': [{'__id__': 1,
                           '__type__': 'Text',
                           'name_scope': 'section_element/text',
                           'text': 'text'}],
             'name': 'Section element',
             'name_scope': 'section_element',
             'title': 'Section 1'}
        )
        self.assertEqual(
            json.loads(Report.from_json(r.to_json(sort_keys=True)).
    ...
    def test_DynamicContent(self):
        ...
        with TemporaryDirectory() as tempdir:
            ...
            self.assertEqual(
                json.loads(r.to_json(sort_keys=True)),
                {"__id__": 0, "__type__": "DynamicContent",
                 "element_id": r.element_id, "html": "HTML only",
                 "name_scope": "dynamic_content"}
            )
            ...
            self.assertEqual(
                ...
                {'__id__': 0,
                 ...
                 'script': {'__id__': 1,
                            ...
                            'extension': '.js',
                            'name': 'Script',
                            'name_scope': 'dynamic_content/script',
                            'path': 'res/dynamic_content/script.js'}}
            )
            ...
            self.assertEqual(
                ...
                {'__id__': 0,
                 ...
                 'data': {'__id__': 1,
                          ...
                          'gzip_compress': True,
                          'name': 'Data',
                          'name_scope': 'dynamic_content/data',
                          'path': 'res/dynamic_content/data.json'},
                 'element_id': r.element_id,
                 'html': 'html content',
                 'name_scope': 'dynamic_content',
                 'script': {'__id__': 2,
            ...
            script_path = tempdir + '/3/res/dynamic_content/script.js'
            with open(script_path, 'rb') as f:
                self.assertEqual(
                    f.read().decode('utf-8'),
                    '(function(){var el=document.getElementById("%s");'
                    'var data=el.getAttribute("dynamic-content-data");'
                    'try{(function($,$el,$data){alert($data);})'
                    '(window.jQuery,el,data);}catch(e){'
                    'el.innerHTML="Failed to execute script: "+e;}})();' %
                    (r.element_id,)
                )
            data_path = tempdir + '/3/res/dynamic_content/data.json.gz'
            with gzip.open(data_path) as f:
                self.assertEqual(f.read().decode('utf-8'), '[1, 2, 3]')
            ...
            self.assertEqual(
                ...
                {'__id__': 0,
                 ...
                 'data': {'__id__': 1,
                          ...
                          'gzip_compress': True,
                          'name': 'Data',
                          'name_scope': 'canvas_js/data',
                          'path': 'res/canvas_js/data.json'},
                 'name_scope': 'canvas_js'}
            )
            with gzip.open(tempdir + '/res/canvas_js/data.json.gz') as f:
                self.assertEqual(
                    json.loads(f.read().decode('utf-8')),
                    {'data': [{'dataPoints': [{'label': 'a', 'y': 1},
                                              {'label': 'b', 'y': 3},
                                              {'label': 'c', 'y': 2}],
                               'type': 'column'}]}
                )
